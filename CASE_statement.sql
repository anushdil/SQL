...
count(CASE WHEN sales_account_type='05'  and voice='Y' THEN mobile_no END ) as type_B,
count(CASE WHEN sales_account_type='09'  and voice='Y' THEN mobile_no END ) as type_C,
